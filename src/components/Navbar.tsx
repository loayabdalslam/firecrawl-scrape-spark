...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full backdrop-blur-sm bg-white/80 dark:bg-gray-950/80 border-b border-gray-200 dark:border-gray-800">
      ...
      {isMenuOpen && (
        <div className="md:hidden p-4 bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800">
